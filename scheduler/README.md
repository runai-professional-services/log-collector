# Log collector: Scheduler

Dumps Run:AI scheduler resources (projects, queues, nodepools, departments) and packages them in a timestamped archive.

## Prerequisites

- `kubectl` installed and configured
- Access to Kubernetes cluster with Run:AI resources
